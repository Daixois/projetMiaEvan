...
class __TwigTemplate_bafbbe2e667f8fa8f1a85e72eb8ec8ad9932970b127bfa118282feb3f706a1b0 extends Template
{
    private $source;
    private $macros = [];
  ...
  <a class=\"btn-login btn-primary\" href=\"";
    ...
    {
        return array (  61 => 11,  55 => 8,  46 => 2,  43 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("<nav class=\"navbar navbar-expand-lg navbar-light bg-light\">
    <a class=\"navbar-brand\" href=\"{{ path('memoryIndex')}}\">Memory</a>
    <button class=\"navbar-toggler\" type=\"button\" data-bs-toggle=\"collapse\" data-bs-target=\"#navbarNav\" aria-controls=\"navbarNav\" aria-expanded=\"false\" aria-label=\"Toggle navigation\">
      <span class=\"navbar-toggler-icon\"></span>
    </button>
    <div class=\"collapse navbar-collapse\" id=\"navbarSupportedContent\">
      <ul class=\"navbar-nav mr-auto\">
        {{ render(path('listTheme')) }}
      </ul>
    </div>
  <a class=\"btn-login btn-primary\" href=\"{{ path('login')}}\" role=\"button\">Se Connecter</a>
</nav>", "partials/_nav.html.twig", "/home/tomdev/projetMiaEvan/projetMiaEvan/templates/partials/_nav.html.twig");
    }
}
